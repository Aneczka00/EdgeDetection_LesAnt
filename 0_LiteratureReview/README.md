...
- Gravity and bathymetry data to identify major tectonic features like fracture zones (FZs) and continental margins

- Multi-Channel Seismic (MCS) and structural data to define continental margin types and their boundaries (COBs)

- Gravity-derived Moho depth and global sedimentary thickness maps for inland plate boundaries
